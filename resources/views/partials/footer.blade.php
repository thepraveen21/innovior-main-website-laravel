    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="footer-column brand-column">
                <a href="{{ route('home') }}" class="footer-logo">Innovior</a>
                <p class="brand-desc">
                    Leading technology company specializing in innovative solutions for the digital age. Transforming businesses through cutting-edge technology and expert consultation.
                </p>
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} Innovior Software Solutions. All Rights Reserved.</p>
        </div>
    </div>
</footer>